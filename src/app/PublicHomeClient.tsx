...
import { BookOpen, Users, Search, ClipboardList, CheckCircle2, AlertCircle, ArrowRight } from 'lucide-react';
      ...
      <div className="mx-auto max-w-7xl space-y-10">
        <section className="grid gap-8 lg:grid-cols-[1.2fr_0.8fr] items-start">
          ...
          <div className="space-y-6">
            ...
            <div id="register" className="rounded-3xl border border-slate-800 bg-slate-900/70 p-6">
              ...
              <form className="mt-6 grid gap-4" onSubmit={handleSubmit}>
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="inline-flex items-center justify-center rounded-2xl bg-indigo-600 px-5 py-3 text-sm font-semibold text-white transition hover:bg-indigo-500 disabled:cursor-not-allowed disabled:opacity-70"
                >
