          ...
          <div className="bg-slate-900/40 border border-slate-800 rounded-2xl p-6 space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className={`p-4 rounded-xl border flex items-center justify-between ${
                checklistToday.some(c => c.jenis === 'buka') 
                ...
                <div>
                  ...
                  <p className="text-xs mt-0.5">
                    {checklistToday.some(c => c.jenis === 'buka') ? 'Selesai diisi hari ini' : 'Belum diisi hari ini'}
                  </p>
                </div>
                {checklistToday.some(c => c.jenis === 'buka') ? (
              ...
              <div className={`p-4 rounded-xl border flex items-center justify-between ${
                checklistToday.some(c => c.jenis === 'tutup') 
                  ? 'bg-emerald-950/20 border-emerald-900/50 text-emerald-400' 
                  : 'bg-slate-950/40 border-slate-800 text-slate-500'
              }`}>
                <div>
                  ...
                  <p className="text-xs mt-0.5">
                    {checklistToday.some(c => c.jenis === 'tutup') ? 'Selesai diisi hari ini' : 'Belum diisi hari ini'}
                  </p>
                </div>
                {checklistToday.some(c => c.jenis === 'tutup') ? (
                  <span className="text-xs font-bold bg-emerald-500/10 px-2.5 py-1 rounded-full">OK</span>
